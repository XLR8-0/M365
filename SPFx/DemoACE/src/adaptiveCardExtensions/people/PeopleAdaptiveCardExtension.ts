...
export const READ_VIEW_REGISTRY_ID: string = 'People_READ_VIEW';
export const CREATE_VIEW_REGISTRY_ID: string = 'People_CREATE_VIEW';
export const UPDATE_VIEW_REGISTRY_ID: string = 'People_UPDATE_VIEW';
export const MESSAGE_VIEW_REGISTRY_ID: string = 'People_MESSAGE_VIEW';
export const DIALOGUE_VIEW_REGISTRY_ID: string = 'People_Dialogue_VIEW';
export const SHOWALLMEDIUM_VIEW_REGISTRY_ID: string = 'People_Medium_VIEW';

const MEDIUM_VIEW_REGISTRY_ID: string = 'People_MEDIUM_VIEW';

export default class PeopleAdaptiveCardExtension extends BaseAdaptiveCardExtension<IPeopleAdaptiveCardExtensionProps, IPeopleAdaptiveCardExtensionState> {
